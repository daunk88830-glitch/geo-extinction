...
/* 실제로 재 보니 반론 생성이 10~13초 걸립니다(따뜻한 상태 기준).
   12초로 두면 절반쯤이 시간 초과로 준비된 문장으로 넘어가서, AI 를 붙인
   의미가 없어집니다. 여유를 두되 무한정 기다리지는 않는 선으로 잡습니다.
   기다리는 동안 버튼이 "반론을 준비하는 중…" 으로 바뀌어 있습니다. */
